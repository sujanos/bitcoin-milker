...
export const CONSENT_PAGE_BASE =
  import.meta.env.VITE_CONSENT_PAGE_BASE_URL || `https://dashboard.heyvincent.ai/consent`;
export const CONSENT_PAGE_DCA_URL = `${CONSENT_PAGE_BASE}/${APP_ID}?redirectUri=${REDIRECT_URI}`;
